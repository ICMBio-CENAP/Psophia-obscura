...
`panel9pt4.fn` <-
function(ni=2000,nb=1000,nt=1,nc=3){
library("R2WinBUGS")
# this function uses the supplied data file "img.data" and creates
...
image(1:40,1:40,Ymat,col=rev(terrain.colors(10)),xlab="Easting",ylab="Northing")
...
out<-bugs (data, inits, parameters, "model.txt", n.thin=nt,n.chains=nc, n.burnin=nb,n.iter=ni,debug=TRUE)
