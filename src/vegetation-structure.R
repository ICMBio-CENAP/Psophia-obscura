...
## matching site order of vegetation.hmsc with site order of X matrix
# first, read X
X <- read.csv("/home/elildojr/Documents/r/hmsc_paper/X.csv", header=T)
