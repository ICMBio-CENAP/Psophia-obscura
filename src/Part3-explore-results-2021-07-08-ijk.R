...
abline(v=0, col="red", lty=2)
hist(out$BUGSoutput$sims.list$beta.psi[,4], xlab="Tree density effect on psi", main="" )
abline(v=0, col="red", lty=2)
hist(out$BUGSoutput$sims.list$beta.psi[,5], xlab="Recovery time effect on psi", main="" )
abline(v=0, col="red", lty=2)
dev.off()
